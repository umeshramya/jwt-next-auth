...
exports.logout = exports.jwtTokenCreate = exports.validateUser = exports.IsPageLogged = exports.jwtverify = exports.jwtSign = void 0;
 ...
 */
const IsPageLogged = (req, res, currentRole = "", permittedRoles = [""]) => {
    return new Promise((resolve, reject) => {
