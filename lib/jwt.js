...
exports.sendApiError = exports.handleApiError = exports.decrypt = exports.encrypt = exports.checkRoles = exports.logout = exports.jwtTokenCreate = exports.validateUser = exports.IsPageLogged = exports.jwtverify = exports.jwtSign = void 0;
 ...
 */
const jwtSign = (payload, req, res, encryption = false) => {
...
const jwtverify = (encryptedToken, encrypted = false) => {
    let token;
    if (encrypted) {
    ...
    return new Promise((resolve, reject) => {
        jsonwebtoken_1.default.verify(token, Secret_Auth, { algorithms: ['HS256'] }, (err, decoded) => {
            if (err) {
                reject(false);
            }
...
//   });
// };
const setJwtTokenCookie = (token, req, res, encryption) => {
...
const handleApiError = (res, error, statusCode = 500, safeMessage) => {
    console.error(`[API Error ${statusCode}]`, error);
    res.status(statusCode).json({ error: safeMessage !== null && safeMessage !== void 0 ? safeMessage : "Internal Server Error" });
};
